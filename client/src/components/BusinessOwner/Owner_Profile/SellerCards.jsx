            ...
            // <Grid container className={classes.root}>
                ...
                <Card  style={{backgroundColor:'  #d4e6f1  ', borderRadius:6, fontFamily:'Monteserrat',height:300,width:350,overflowY:'visible',scrollBehavior:'smooth',scrollbarWidth:'thin'}}>
                    ...
                    <CardHeader 
                        ...
                        title={<Typography style={{color:'black',fontFamily: ['Montserrat', 'sans-serif'],fontSize:'1.5rem'}}>Shop Name</Typography>}
                        subheader={<Typography style={{ color: '#A1B3BA',fontweight: 'light',fontFamily: ['Montserrat', 'sans-serif'],fontSize:'1rem'}}><LocationOnOutlinedIcon fontSize='small'/>Seller Address Seller Address Seller Address Seller Address Seller Address Seller Address Seller Address Seller Address Seller Address </Typography>}
                    >
                    ...
                    <Grid container  >
                        <Grid item lg={12} >
                        <Typography  style={{color:'#34495e', fontFamily: ['Montserrat', 'sans-serif'],fontSize:'1rem',marginTop:20,marginBottom:4}}>Contact : 1234567890</Typography>
                        </Grid>
