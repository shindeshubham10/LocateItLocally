...
import { makeStyles } from "@material-ui/styles";
 ...
 const LoginErrorDialog = ({errorDialog,seterrorDialog}) => {
    ...
    <Dialog open={errorDialog}>
        ...
        <DialogContent className={classes.mainDialog} >
         ...
         <Grid item xs={12} md={7} lg={6} className={classes.heading}> 
            <Typography style={{fontSize:15,fontFamily:['Monteserrat','sans-serif'],fontWeight:400,}}>Invalid ID or Password</Typography> 
         </Grid>
